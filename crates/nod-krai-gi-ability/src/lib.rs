...
impl Plugin for AbilityPlugin {
    fn build(&self, app: &mut App) {
        app
            // Define system sets with execution order
            .configure_sets(
                Update,
                AbilitySystemSet::Ability.before(AbilitySystemSet::Modifier),
            )
            .configure_sets(
                Update,
                AbilitySystemSet::Modifier.before(AbilitySystemSet::GlobalValue),
            )
            .configure_sets(
                Update,
                AbilitySystemSet::GlobalValue.before(AbilitySystemSet::Other),
            )
            // Ability set
            .add_systems(
                PreUpdate,
            ...
            .add_systems(
                Update,
                ability_action_set_override_map_value_event.in_set(AbilitySystemSet::GlobalValue),
            )
            .add_systems(
                Update,
                ability_action_set_random_override_map_value_event
                    .in_set(AbilitySystemSet::GlobalValue),
            )
            .add_systems(
                Update,
            ...
            .add_systems(
                Update,
                ability_action_set_global_value_event.in_set(AbilitySystemSet::GlobalValue),
            )
            .add_systems(
                Update,
                ability_action_add_global_value_event.in_set(AbilitySystemSet::GlobalValue),
            )
            .add_systems(
                Update,
                ability_action_copy_global_value_event.in_set(AbilitySystemSet::GlobalValue),
            )
            .add_systems(
                Update,
                ability_action_clear_global_value_event.in_set(AbilitySystemSet::GlobalValue),
            )
            .add_systems(
                Update,
                ability_action_heal_hp_event.in_set(AbilitySystemSet::Other),
            )
            .add_systems(
                Update,
                ability_action_lose_hp_event.in_set(AbilitySystemSet::Other),
            )
            .add_systems(
                Update,
                ability_action_get_hp_paid_debts_event.in_set(AbilitySystemSet::Other),
            )
            .add_systems(
                Update,
                ability_action_add_hp_debts_event.in_set(AbilitySystemSet::Other),
            )
            .add_systems(
                Update,
